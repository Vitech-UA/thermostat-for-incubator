...
_0x0:
	.DB  0x49,0x6E,0x63,0x75,0x62,0x61,0x74,0x6F
	.DB  0x72,0x3D,0x20,0x0,0x54,0x65,0x72,0x6D
	.DB  0x6F,0x73,0x74,0x61,0x74,0x3D,0x20,0x0
_0x2020003:
	.DB  0x80,0xC0
_0x2040060:
	.DB  0x1
...
; 0000 0030            ftoa(Dtemper,1,lcd_buffer2);
	...
	LDI  R30,LOW(1)
	ST   -Y,R30
	LDI  R26,LOW(_lcd_buffer2)
	LDI  R27,HIGH(_lcd_buffer2)
	RCALL _ftoa
